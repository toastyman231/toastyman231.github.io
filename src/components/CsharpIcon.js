...
const CSharpIcon = ({className, size}) => {
    return(
        <svg className={className} stroke="currentcolor" fill="currentcolor" stroke-width="0" role="img" viewBox="0 0 24 24" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
            <title></title>
